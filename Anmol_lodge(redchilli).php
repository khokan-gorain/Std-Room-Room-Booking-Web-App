...
include('db_connection.php');
 ...
 $query = " select * from $table_name where verify_code = '4011' ";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
     ...
     <!-- css-->
      <link rel="stylesheet" href="Anmol_lodge(redchilli).css" type="text/css">
      ...
      <div class="continer lodge-discription">
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
           <div class="card-view">
                 <h3 class="lodge-name">Anmol Lodge</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                      <p class="room-type-title-head">four Bed Room </p>
                    </div>
                </div>
                   ...
                   <div class="row amount">
                       <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                          <div class="row ">
                            <div class="col-lg-7 col-md-7 col-sm-7 col-7 col-7"><h4 class="text-center room-rent">&#8377; <?php echo "$triple_ren" ; ?></h4></div>
                           <div class="col-lg-5 col-md-5 col-sm-5 col-5 col-5"><h5 class="discount-room-rent">&#8377; 1050</h5></div>  
                           </div>
                           <p class="total-amount">Total amount</p>
                 </div> 
                 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                <a href="tel:6299568151"><input type="button" class="call-btn" value="CALL US TO BOOK" name=""></a>
                 </div>   
             </div>
               </div>
              </div>
  ...
  <div class="carousel-inner">
    ...
    <a href="image/anmol_lodge(redchilli)1.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/anmol_lodge(redchilli)1.jpg" alt="First slide"> </a>
    </div>
    <div class="carousel-item">
    <a href="image/anmol_lodge(redchilli)2.jpg" target="_blank">  <img class="d-block w-100 lodge-img" src="image/anmol_lodge(redchilli)2.jpg" alt="Second slide"></a>
    </div>
    <div class="carousel-item">
     <a href="image/anmol_lodge(redchilli)3.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/anmol_lodge(redchilli)3.jpg" alt="Third slide"> </a>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="row mt-3">
          ...
          <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-3 text-center">
            <p class="room-type-title">Four Bed</p>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
         ...
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
               <a href="tel:6204670625">  <input type="button" class="call-now-btn" value="BOOK NOW" name=""></a>
                 </div> 
          </div>
       </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 text">
                      ...
                      <p class="discription-title">Discription</p>
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Anmol Lodge is one of the best lodge for every students. All facilities are available.</p>
                           </div>
                        </div>
                    ...
                    <p class="discription-title">Location</p>
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">S.P college road Rashikpur. Hotel Anmol Red Chilli.</p>
                        </div>
                        </div>
                    ...
                    <span class="read-more-text">
                       ...
                       <p class="discription-title">Facilities</p>
                        ...
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Safety Lockers</p>
                        </div>
                        </div>
                        <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                        ...
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">RO Water</p>
                        </div>
                        </div>
                           <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Inverter Support 24/7</p>
                        </div>
                        </div>
                        
                        <p class="discription-title">Mess System</p>
                        <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                             <i class="far fa-check-circle fa-lg"></i>
                          </div>
                         <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Lunch+Dinner(Full Plate)</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">RS-2100</p>
                        </div>
                        </div>
                         ...
                         <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Lunch+Dinner(Half Plate)</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">RS-1500</p>
                        </div>
                        </div>
                        ...
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Breakfast(Optional)</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">RS-600</p>
                        </div>
                        </div>
                        ...
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">SP College</p>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">1 KM</p>
                        </div>
                        </div>
                        ...
                        <div class="row ml-1">
                          ...
                          <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Red Chilli Mess</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">0 M</p>
                        </div>
                        </div>
             ...
             <div class="container">
               <p class="rule-and-regulation-title text-center">Rule & Regulation</p>
                  ...
                  <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">If you stay at Anmol Lodge, you will have to have lunch and dinner at Red Chilli Mess.</p>
                        </div>
                        </div>
