...
include('db_connection.php');
 ...
 $query = " select * from $table_name where verify_code = '108' ";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
     ...
     <!-- css-->
      <link rel="stylesheet" href="badentlodge.css" type="text/css">
      ...
      <div class="continer lodge-discription">
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
           <div class="card-view">
                 <h3 class="lodge-name">Badent Lodge</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                      <p class="room-type-title-head">Single Bed Room</p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                      <p class="room-type-title-head">Dubble Bed Room </p>
                    </div>
                </div>
                     <div class="row">
                    <div class="col-lg-1 col-md-1 col-sm-1 col-1">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                      <p class="room-type-title-head">Treeple Bed Room</p>
                    </div>
                </div>    
                </div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                   <input type="button" class="call-btn" value="CALL US TO BOOK" name="">
                 </div>   
             </div>
               </div>
              </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 lodge-img" src="image/1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 lodge-img" src="image/1.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 lodge-img" src="image/1.jpg" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="row mt-3">
         ...
         <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-3 text-center">
           <p class="room-type-title">Single Bed</p>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
          <p class="room-type-title"><?php echo "$single_total_room" ; ?></p>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
          <p class="room-type-title"><?php echo "$single_avalable_room" ; ?></p>
          </div>
              <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
          <p class="room-type-title"><?php echo "$single_total_bed_avalable" ; ?></p>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
          <p class="room-type-title"><?php echo "$single_rent" ; ?></p>
          </div>
          </div>
    
          <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-3 text-center">
            <p class="room-type-title">Dubble Bed</p>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
         ...
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                   <input type="button" class="call-now-btn" value="BOOK NOW" name="">
                 </div> 
          </div>
       </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <p class="discription-title">Discription</p>
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title"> This lodge is locate badaband shivmandir rashikpur  dumka. nare polytechnic college dumka..</p>
                           </div>
                        </div>
                    ...
                    <span class="read-more-text">
                       ...
                       <p class="discription-title">Features</p>
                        <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                             <i class="far fa-check-circle fa-lg"></i>
                          </div>
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Fan are avalable</p>
                        </div>
                        </div>
                        <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Supply Water</p>
                        </div>
                        </div>
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">No Current Bile</p>
                        </div>
                        </div>
                        <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                        ...
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Engineering College</p>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">600 M</p>
                        </div>
                        </div>
                        ...
                        <div class="row ml-1">
                          ...
                          <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Maa Tara Mass</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                           <p class="discription-sub-title">600 M</p>
                        </div>
                        ...
                        <div class="row ml-1">
                          ...
                          <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                           <p class="discription-sub-title">Red Chille Mass</p>
                        </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
             ...
             <div class="container">
               <p class="rule-and-regulation-title text-center">Rule & Regulation</p>
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Does not allow many firnds.</p>
                        </div>
                        </div>
                    <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img-rule">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Always cline your room.</p>
                        </div>
                        </div>
                   <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img-rule">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Late night no entry any student.</p>
                        </div>
                        </div>
                   <div class="row ml-1">
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img-rule">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Requere one Id proof.</p>
                        </div>
                        </div>
