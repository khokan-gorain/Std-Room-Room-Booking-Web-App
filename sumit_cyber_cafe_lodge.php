...
include('db_connection.php');
 ...
 $query = " select * from $table_name where verify_code = '4008' ";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
     ...
     <!-- css-->
      <link rel="stylesheet" href="sumit_cyber_cafe_lodge.css" type="text/css">
    ...
    <title>sumit cyber cafe lodge</title>
  </head>
  <body>
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
           <div class="card-view">
                ...
                <div class="row">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                <a href="tel:9801319965"><input type="button" class="call-btn" value="CALL US TO BOOK" name=""></a>
                 </div>   
             </div>
               </div>
              </div>
  ...
  <div class="carousel-inner">
    ...
    <a href="image/sumit_cyber_cafe1.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/sumit_cyber_cafe1.jpg" alt="First slide"> </a>
    </div>
    <div class="carousel-item">
    <a href="image/sumit_cyber_cafe2.jpg" target="_blank">  <img class="d-block w-100 lodge-img" src="image/sumit_cyber_cafe2.jpg" alt="Second slide"></a>
    </div>
    <div class="carousel-item">
     <a href="image/sumit_cyber_cafe3.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/sumit_cyber_cafe3.jpg" alt="Third slide"> </a>
    </div>
  </div>
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="row mt-3">
       ...
       <div class="row">
         ...
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
               <a href="tel:9801319965">  <input type="button" class="call-now-btn" value="BOOK NOW" name=""></a>
                 </div> 
          </div>
       </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 text">
                      ...
                      <p class="discription-title">Discription</p>
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Sumit Cyber Cafe Lodge is one of the best lodge for every students. All facilities are available.</p>
                           </div>
                        </div>
