...
include('db_connection.php');
 ...
 $query = " select * from $table_name where verify_code = '4002' ";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
     ...
     <!-- css-->
      <link rel="stylesheet" href="mg_lodge.css" type="text/css">
                   ...
                   <div class="row amount">
                       <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                          <div class="row ">
                           ...
                           <div class="col-lg-5 col-md-5 col-sm-5 col-5 col-5"><h5 class="discount-room-rent">&#8377; 1250</h5></div>  
                           </div>
                           <p class="total-amount">Total amount</p>
                 </div> 
                 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                 <a href="tel:9304143689">  <input type="button" class="call-btn" value="CALL US TO BOOK" name=""></a>
                 </div>   
             </div>
               </div>
              </div>
  ...
  <div class="carousel-inner">
    ...
    <a href="image/mg_lodge1.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/mg_lodge1.jpg" alt="First slide"> </a>
    </div>
    <div class="carousel-item">
    <a href="image/mg_lodge2.jpg" target="_blank">  <img class="d-block w-100 lodge-img" src="image/mg_lodge2.jpg" alt="Second slide"></a>
    </div>
    <div class="carousel-item">
     <a href="image/mg_lodge3.jpg" target="_blank"> <img class="d-block w-100 lodge-img" src="image/mg_lodge3.jpg" alt="Third slide"> </a>
    </div>
  </div>
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="row mt-3">
       ...
       <div class="row">
         ...
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
                  <a href="tel:9304143689"> <input type="button" class="call-now-btn" value="BOOK NOW" name=""> </a>
                 </div> 
          </div>
       </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 text">
                      ...
                      <p class="discription-title">Discription</p>
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 col-1 font-aws-img">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">MG Lodge is one of the best lodge for every students. Covered By 5G InterNet Technology and CCTV Camera.</p>
                           </div>
                        </div>
                    ...
                    <p class="discription-title">Location</p>
                        <div class="row ml-1">
                         ...
                         <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                           <p class="discription-sub-title">Rashikpur Sonwadangal, Lichi Bagan Road Dumka.</p>
                        </div>
                        </div>
