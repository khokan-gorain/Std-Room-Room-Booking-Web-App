...
include('db_connection.php');
 ...
 $query = " select * from $table_name where verify_code = '4009' ";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
     ...
     <!-- css-->
      <link rel="stylesheet" href="mandal_lodge1.css" type="text/css">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
           <div class="card-view">
                ...
                <div class="row">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                <a href="tel:7903906672"><input type="button" class="call-btn" value="CALL US TO BOOK" name=""></a>
                 </div>   
             </div>
               </div>
              </div>
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="row mt-3">
       ...
       <div class="row">
         ...
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
               <a href="tel:7903906672">  <input type="button" class="call-now-btn" value="BOOK NOW" name=""></a>
                 </div> 
          </div>
       </div>
